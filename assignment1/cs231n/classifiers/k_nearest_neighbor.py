...
class KNearestNeighbor(object):
    ...
    def compute_distances_no_loops(self, X):
        ...
        train2 = np.sum(self.X_train * self.X_train, axis=1)      # (num_train,)
        train2 = train2.reshape(1, -1)                            # (1, num_train)

        # cross term
        cross = X.dot(self.X_train.T)                             # (num_test, num_train)

        # squared distances, then sqrt
        dists = np.sqrt(X2 + train2 - 2.0 * cross)
        #########################################################################
        # TODO:                                                                 #
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            closest_y = self.y_train[k_idx].tolist()
